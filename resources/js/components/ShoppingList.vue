        ...
        <div v-if="inputs.length > 0">
            <div class="table-responsive">
                <table class="table table-striped table-bordered">
                    ...
                    <tfoot>
                        <tr>
                            <th><span :class="'label label-' + typeColor">{{ type.toUpperCase() }}</span></th>
	...
	export default {
		...
		methods: {
            ...
            deleteRow(index, family) {
                let category = this.inputs[index].type == 'EQUIPO' ? 'equipo': 'varios'
            ...
            updateTypes(product) {
                let category = product.type == 'EQUIPO' ? 'equipo': 'varios'
