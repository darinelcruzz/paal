    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <solid-box title="Agregar egreso" color="success" button>
                {!! Form::open(['method' => 'POST', 'route' => 'mbe.egress.general.store', 'enctype' => 'multipart/form-data']) !!}

                    <div class="row">
                        <div class="col-md-6">
                            <label><b>Proveedor</b></label><br>
                            <v-select label="name" :options="providers.mbe.general" v-model="provider" placeholder="Seleccione un proveedor...">
                            </v-select>
