...
@section('content')
    <div class="row">
        <div class="col-md-6">
            <solid-box title="Agregar factura al cheque {{ $check->folio }}" color="success" button>
                {!! Form::open(['method' => 'POST', 'route' => ['mbe.egress.register.store', $check], 'enctype' => 'multipart/form-data']) !!}

                    <div class="row">
                        <div class="col-md-12">
                            <label><b>Proveedor</b></label><br>
                            <v-select label="name" :options="providers.mbe.register" v-model="provider" placeholder="Seleccione un proveedor...">
                            </v-select>
