...
@push('headerTitle')
    <div class="row">
        ...
        <div class="col-md-7" style="text-align: center;">
            @include('mbe.tasks._indicators')
        </div>
        <div class="col-md-3">
            <div class="pull-right">
                {!! Form::open(['method' => 'post', 'route' => 'mbe.task.index']) !!}
...
@section('content')
        ...
        <div class="row">
            <div class="col-md-12">
                <solid-box title="{{ $tasks->first()->user->name }}" color="{{ $loop->iteration % 2 == 0 ? 'danger': 'warning' }}" button {{ $loop->iteration == 1 ? '': ' collapsed'}}>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            @include('mbe.tasks._indicators', ['buttonSize' => 'btn-xs'])
                        </div>
                    </div>
    ...
    @empty
        <h2 align="center">
            <code>NO SE ASIGNARON TAREAS</code>
        </h2>
    @endforelse
