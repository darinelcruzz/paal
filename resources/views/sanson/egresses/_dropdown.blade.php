...
@if($egress->pdf_bill)
    ...
    <modal id="pdf{{ $egress->id}}" title="Factura (pdf)">
        ...
        <embed src="{{ route('sanson.egress.displayPDF', [$egress, 'pdf_bill']) }}" style="width:100%; height:800px;" frameborder="0">
	</modal>
...
@if($egress->pdf_complement)
    ...
    <modal id="pdf_complement_{{ $egress->id}}" title="Factura (pdf)">
        ...
        <embed src="{{ route('sanson.egress.displayPDF', [$egress, 'pdf_complement']) }}" style="width:100%; height:800px;" frameborder="0">
	</modal>
...
@if($egress->pdf_payment)
    ...
    <modal id="ppdf{{ $egress->id}}" title="Pago (pdf)">
        ...
        <embed src="{{ route('sanson.egress.displayPDF', [$egress, 'pdf_payment']) }}" style="width:100%; height:800px;" frameborder="0">
	</modal>
